  ...
  <!-- <Card class="easy-cron"> -->
    <div class="content">
      ...
      <div style="width:600px">
        <Tabs size="small" v-model="curtab" name="vueEasyCron">
          <TabPane label="秒" name="second" tab="vueEasyCron" v-if="!hideSecond"><second-ui v-model="second" :disabled="disabled"></second-ui></TabPane>
          <TabPane label="分" name="minute" tab="vueEasyCron"><minute-ui v-model="minute" :disabled="disabled"></minute-ui></TabPane>
          <TabPane label="时" name="hour" tab="vueEasyCron"><hour-ui v-model="hour" :disabled="disabled"></hour-ui></TabPane>
          <TabPane label="日" name="day" tab="vueEasyCron"><day-ui v-model="day" :week="week" :disabled="disabled"></day-ui></TabPane>
          <TabPane label="月" name="month" tab="vueEasyCron"><month-ui v-model="month" :disabled="disabled"></month-ui></TabPane>
          <TabPane label="周" name="week" tab="vueEasyCron"><week-ui v-model="week" :day="day" :disabled="disabled"></week-ui></TabPane>
          <TabPane label="年" name="year" tab="vueEasyCron" v-if="!hideYear && !hideSecond"><year-ui v-model="year" :disabled="disabled"></year-ui></TabPane>
        </Tabs>
      </div>
      <!-- <div class="right">
        ...
        <div class="exe-pre">
          ...
          <div class="exe-pre-panel">
            ...
            <Input type="textarea" :value="preTimeList" class="p-right" :rows="10" readonly />
          </div>
        </div>
      </div> -->
    </div>
