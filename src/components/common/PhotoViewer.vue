...
<template>
  <Row class="photo-viewer" v-if="opened" v-show="mVisible">
    <i-col span="24">
      ...
      <Icon class="chevron" @click.native="leftClick" v-show="imgs && index-1>=0" type="ios-arrow-dropleft"
            style="left: 0;"></Icon>
      <Icon class="chevron" @click.native="rightClick" v-show="imgs && index+1<imgs.length" type="ios-arrow-dropright"
            style="right: 0;"></Icon>
    </i-col>
